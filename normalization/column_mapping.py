"""
Mapeamento de colunas históricas da RAIS.

Objetivo:
    Padronizar nomes de colunas entre
    diferentes versões da RAIS.

Observação:
    Baseado no pipeline do Base dos Dados.
"""
...
VINCULOS_RENAME = {
    ...
    "Vl Rem Janeiro CC": "valor_remuneracao_janeiro",
    "Vl Rem Fevereiro CC": "valor_remuneracao_fevereiro",
    "Vl Rem Março CC": "valor_remuneracao_marco",
    "Vl Rem Abril CC": "valor_remuneracao_abril",
    "Vl Rem Maio CC": "valor_remuneracao_maio",
    "Vl Rem Junho CC": "valor_remuneracao_junho",
    "Vl Rem Julho CC": "valor_remuneracao_julho",
    "Vl Rem Agosto CC": "valor_remuneracao_agosto",
    "Vl Rem Setembro CC": "valor_remuneracao_setembro",
    "Vl Rem Outubro CC": "valor_remuneracao_outubro",
    "Vl Rem Novembro CC": "valor_remuneracao_novembro",
    ...
    "Tipo Estabelecimento - Nome": "tipo_estabelecimento_nome",
    "Tipo Estab.1": "tipo_estabelecimento_nome",
    "Natureza Jurídica": "natureza_juridica",
    "Natureza Jurídica - Código": "natureza_juridica",
    "Ind Simples": "indicador_simples",
